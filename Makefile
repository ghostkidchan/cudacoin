#############################################################################
# Makefile for building: cudacoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Mar 4 05:03:54 2018
# Project:  cudacoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 USE_QRCODE=1 -o Makefile cudacoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -Wl,-z,relro -Wl,-z,now -lqrencode -lminiupnpc /home/rudichan/Desktop/cryptocurrency/cudacoin/src/leveldb/libleveldb.a /home/rudichan/Desktop/cryptocurrency/cudacoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: cudacoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 USE_QRCODE=1 -o Makefile cudacoin-qt.pro
...
/home/rudichan/Desktop/cryptocurrency/cudacoin/src/leveldb/libleveldb.a: FORCE
	cd /home/rudichan/Desktop/cryptocurrency/cudacoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/rudichan/Desktop/cryptocurrency/cudacoin/build/build.h: FORCE
	cd /home/rudichan/Desktop/cryptocurrency/cudacoin; /bin/sh share/genbuild.sh /home/rudichan/Desktop/cryptocurrency/cudacoin/build/build.h
